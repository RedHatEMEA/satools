...
set title "SA tools: unique IPs accessing per month, 15/04/14"
...
set title "SA tools: unique users accessing per month, 15/04/14"
...
set title "SA tools: actions carried out per month, 15/04/14"
