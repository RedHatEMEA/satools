...
set title "SA tools: unique IPs accessing per month, 05/08/13"
...
set title "SA tools: unique users accessing per month, 05/08/13"
...
set title "SA tools: actions carried out per month, 05/08/13"
