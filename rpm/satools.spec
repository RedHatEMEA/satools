...
BuildRequires:	python3-devel, python3-ply, redhat-rpm-config
...
%posttrans
for i in elluminate lgrep mailindex sync-gsa sync-jive sync-lists sync-product-docs sync-pt sync-resourcelibrary sync-rhn-channel-dumps sync-webdav
do
